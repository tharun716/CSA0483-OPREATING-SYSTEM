...
void initialize() {
    ...
    available[1] = 1;
    available[2] = 2;
    maximum[0][0] = 6; maximum[0][1] = 5; maximum[0][2] = 1;
    maximum[1][0] = 9; maximum[1][1] = 9; maximum[1][2] = 2;
    maximum[2][0] = 9; maximum[2][1] = 5; maximum[2][2] = 0;
    maximum[3][0] = 2; maximum[3][1] = 0; maximum[3][2] = 1;
    maximum[4][0] = 3; maximum[4][1] = 3; maximum[4][2] = 9;
